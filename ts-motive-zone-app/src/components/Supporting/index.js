        ...
        <section className="supporting-section">
            <div className="supporting-section__title">
                ...
                <div className="supporting-title__para-group">
                    <p className="global__paragraph">But I must explain to you how all this mistaken idea of denouncing
                    ...
                    <p className="global__paragraph">Of the truth, the master-builder of human happiness. No one rejects,
