    ...
    const items: ProjectItem[] = [
        {
            ...
            projectInfo: `Find fault with a man who chooses to enjoy 
            a pleasure that has no annoying.`,
            img: lastestProject1
        },
        {
            id: 1,
            projectTitle: 'Food &amp; restaurant',
            projectInfo: `Temporibus autem quibusdam et aut officiis 
        ...
        },
        {
            ...
            projectInfo: `Itaque earum rerum hic tenetur a sapiente delectus,
        ...
        <section className="projects-section--background">
            <div className="projects-section--container">
                <div className="projects-section__title">
                    ...
                    <p className="global__paragraph border-text-1">To take a trivial example,
                    which of us ever undertakes laborious physical exercise,
                      except to obtain some advantage But who has any right</p>
                </div>
